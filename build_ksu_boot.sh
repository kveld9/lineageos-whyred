...
# ==============================================================================
# LineageOS - Dedicated KernelSU Next + SuSFS Boot Image Builder
# ==============================================================================
# Checks out the isolated lineage-21-ksu kernel branch, compiles bootimage,
# saves boot-ksu.img in target output directory, and safely restores stock branch.
# ==============================================================================
...
KSU_BRANCH="${KSU_BRANCH:-lineage-21-ksu}"

echo "=========================================================="
echo " Building KernelSU Next + SuSFS Boot Image for ${DEVICE}"
echo "=========================================================="
...
echo "Switching kernel tree to '${KSU_BRANCH}'..."
git -C "${KERNEL_DIR}" checkout "${KSU_BRANCH}"
